...
@export var atlas_coordinate : Vector2i
@export var fill_color_A     : Color
@export var fill_color_B     : Color

func _init(p_atlas_id : Array[String] = ["","",""], p_atlas_coordinate := Vector2i.ZERO, p_fill_color_A := Color.WHITE, p_fill_color_B := Color.WHITE):
	atlas_id = p_atlas_id
